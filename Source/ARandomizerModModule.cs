...
namespace Celeste.Mod.ARandomizerMod {
    public class ARandomizerModModule : EverestModule {
        ...
        public override Type SaveDataType => typeof(ARandomizerModModuleSaveData);
        public static ARandomizerModModuleSaveData SaveData => (ARandomizerModModuleSaveData) Instance._SaveData;
